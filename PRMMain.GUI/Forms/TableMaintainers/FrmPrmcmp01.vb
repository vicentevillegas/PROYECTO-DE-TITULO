...
#Region "#### Public & Private Global Objects"
    ...
    Public objectBO As New PrmcmpBO
...
#Region "### Maintainer Initializer"
    ...
    Private Sub frmTemplate01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        indexesMsg = $"prmcmp: {txtPrmcmp.Text.Trim}"

        If rowAdding Then
            Me.Text = Me.Text.Trim & " ADDING"
        ElseIf rowCopy Then
            Me.Text = Me.Text.Trim & $" COPYING (Company)"
        Else
            Me.Text = Me.Text.Trim & $" UPDATING (Company: {indexesMsg})"
        End If
...
#Region "### Buttons Events, Functions and Subs"
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
		...
		'
		If String.IsNullOrEmpty(txtPrmcmp.Text.Trim()) Then
			MessageBox.Show("Company Id must be entered", "Company Id Missing", MessageBoxButtons.OK, MessageBoxIcon.Error)
			txtPrmcmp.Select()
			Exit Sub
		End If
		...
		'
            ...
            objectBO.chgusr = ""
            Dim success As Boolean = PrmcmpBLL.Insert(objectBO)
		...
		'
            ...
            objectBO.chgmod = "prmcmp01"
            objectBO.chgstm = Date.Now
            objectBO.chgusr = FrmMain.SecusrBO.Secusr.Trim
            Dim success As Boolean = PrmcmpBLL.Update(objectBO)
...
#Region "### ADD, COPY & UPDATE Subs"
    ...
    Private Sub setForUpdate()
		...
		'
		txtPrmcmp.Text = If(objectBO.prmcmp Is Nothing, String.Empty, objectBO.prmcmp.Trim)
		...
		'
		txtPrmcmp.ReadOnly = True
		txtPrmcmp.TabStop = False
		'
		'End Code.
		'
