...
#Region "#### Public & Private Global Objects"
    ...
    Public meTableDescr As String = "Company"
    Public iUserLoc As String = "PRMMain"
    Public FormSelectedObject As New PrmcmpBO
...
#Region "### Maintainer Initializer"
    ...
    Private Sub FrmPrmcmp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        totalRecords = PrmcmpBLL.GetTotalRecords(False)
		...
		txtDescr.BackColor = Color.Honeydew
		'
		'End Code.
		'
		...
		txtDescr.BackColor = Color.LightYellow
		'
		'End Code.
		'
...
#Region "### Add, Copy, Refresh, Print, Edit and Delete Buttons Click Events, Functions and Subs"
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Dim Form01 As New FrmPrmcmp01
        Form01.rowAdding = True
        Dim objectBO As New PrmcmpBO
		...
		'
			newrow.Item("prmcmp") = If(objectBO.prmcmp Is Nothing, "", objectBO.prmcmp.Trim)
    ...
    Private Sub btnCopy_Click(sender As Object, e As EventArgs) Handles btnCopy.Click
        ...
        Dim objectBO = New PrmcmpBO
        '
		'Code to Get Only the Object indexes(PKs).
		'
		objectBO.prmcmp = thisRow.Item("prmcmp").ToString.Trim
		'
		'End Code.
		'
        objectBO = PrmcmpBLL.GetUnique(objectBO)
        Form01.objectBO = objectBO
        Form01.ShowDialog()
        objectBO = Form01.objectBO
    ...
    Private Sub gridTemplate_myGridCellClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grid.myGridCellClick
		...
		'
			...
			'
			thisRow.Item("prmcmp") = If(objectBO.prmcmp Is Nothing, "", objectBO.prmcmp.Trim)
        ...
        If columnName.Trim = "delButton" And delCell.Enabled Then
            ...
            If MessageBox.Show("Are you sure you wish to delete Company: " & vbCrLf  & thisRow.Item("Prmcmp").ToString.Trim  & " ?",
		...
		'
            ...
            Try
                ...
                Dim deleted As Boolean = PrmcmpBLL.Delete(objectBO)
            ...
            Catch ex As Exception
                ...
                If _message.Trim.Length > 6 Then
                    ...
                    If _message.Substring(0, 7) = "SQL0532" Then
                        ...
                        _message = _message & vbCrLf & "Company: "  & thisRow.Item("Prmcmp").ToString.Trim  & " is used in the above mentioned table" & vbCrLf & "Would You like to mark this code inactive?"
		...
		'
                    objectBO = PrmcmpBLL.GetUnique(objectBO)
                    objectBO.active = "F"
                    Dim updated As Boolean = PrmcmpBLL.Update(objectBO)
                    '
			'Code to Get the thisRow.Items Columns for Main Grid.
			'
			thisRow.Item("prmcmp") = If(objectBO.prmcmp Is Nothing, "", objectBO.prmcmp.Trim)
...
#Region "### Getting and Filtering Main Grid Local Data"
    ...
    Private Function GetFilterStringForLocalData() As String
        ...
        If Not String.IsNullOrEmpty(txtDescr.Text.Trim()) Then
			If (filter.Length > 0) Then
				filter.Append(" and ")
			End If
			filter.Append("descr like '%" + txtDescr.Text.Trim().Replace("%", "[%]").Replace("'", "''") + "%'")
		End If
		'
		'End Code.
		'
    ...
    Private Sub RefreshMessages()
		...
		'
		If Not String.IsNullOrEmpty(txtPrmcmp.Text.Trim()) Then
			filter.Append($"Company Id(Start with: '{txtPrmcmp.Text.Trim()}')")
		End If
		If Not String.IsNullOrEmpty(txtDescr.Text.Trim()) Then
			If (filter.Length > 0) Then
				filter.Append(", ")
			End If
			filter.Append($"Description(Contains: '{txtDescr.Text.Trim()}')")
		End If
		'
		'End Code.
		'
    ...
    Private Sub TextBoxes_TextChanged(sender As Object, e As EventArgs) Handles txtPrmcmp.TextChanged, txtDescr.TextChanged
    ...
    Private Sub txt_KeyDown(sender As Object, e As KeyEventArgs) Handles txtPrmcmp.KeyDown, txtDescr.KeyDown
...
#Region "### Getting and Filtering Main Grid Remote Data"
    ...
    Private Sub bgwLoadData_DoWork(ByVal sender As Object, ByVal e As DoWorkEventArgs) Handles bgwLoadData.DoWork
        ...
        sqlQuery = $"select 
                            {sqlButtons}                                         
                            crsfile.Prmcmp.prmcmp as prmcmp,
							crsfile.Prmcmp.descr as descr,
							crsfile.Prmcmp.active as active                            
                         from
	                        crsfile.Prmcmp
                                
                         where {If(Not ShowAllRecors, " crsfile.Prmcmp.active = 'T' ", " crsfile.Prmcmp.active in ('T','F') ")}
                            {RemoteFilterString}"

        'Debug.Write(sqlQuery)
        Try
            table = PrmcmpBLL.GetTable(sqlQuery)
        Catch ex As Exception
...
#Region "### Resize Main Grid Columns"
    ...
    Private Sub FrmPrmcmp_ResizeEnd(sender As Object, e As EventArgs) Handles MyBase.ResizeEnd
...
#Region "### Window Short Cuts"
    ...
    Private Sub FrmPrmcmp_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub cbcActiveRecrods_DropDownItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles cbcActiveRecrods.DropDownItemClicked
        ...
        Select Case e.ClickedItem.Tag
            ...
            Case "noactive"
                ...
                totalRecords = PrmcmpBLL.GetTotalRecords(True)
